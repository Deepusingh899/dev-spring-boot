...
public class MyDemoLoggingAspect {
    ...
    @Around("execution(* com.learn2code.AOPDemo.service.*.getFortune(..))")
    public Object aroundGetFortune(ProceedingJoinPoint theProceedJoitPoint)throws Throwable{
        //print out method we are advising
        String method=theProceedJoitPoint.getSignature().toShortString();
        System.out.println("\n =======> Executing @Around method :- "+method);

        //get begin timestamp
        long begin=System.currentTimeMillis();

        //excute the given method
        Object result=theProceedJoitPoint.proceed();
        ...
        long diff=end-begin;
        System.out.println("The Difference Time :- "+diff/1000.0+" seconds");

        return result;
    }

    @After("execution(* com.learn2code.AOPDemo.dao.AccountDAO.findAccounts(..))")
