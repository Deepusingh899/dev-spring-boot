...
//			demoTheAroundAdviseHandleException(theTrafficFortuneService);
			demoTheAroundAdviseRethrowException(theTrafficFortuneService);


		};
	}

	private void demoTheAroundAdviseRethrowException(TrafficFortuneService theTrafficFortuneService) {
		System.out.println("ain Programme Demo App: demoTheAroundAdviseRethrowException");
	...
	private void demoTheAroundAdviseHandleException(TrafficFortuneService theTrafficFortuneService) {
		System.out.println("ain Programme Demo App: demoTheAroundAdviseHandleException");
		System.out.println("Calling get Fortune");
		boolean tripWire=true;
		String data=theTrafficFortuneService.getFortune(tripWire);
		System.out.println("\nMy Fortune is :- "+data);
